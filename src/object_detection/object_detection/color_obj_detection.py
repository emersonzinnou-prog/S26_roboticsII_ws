...
class ColorObjDetectionNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('color_low', [19, 74, 91])
        self.declare_parameter('color_high', [22, 59, 99])
        self.declare_parameter('color_low', [0, 0, 0])
        self.declare_parameter('color_high', [0, 0, 0])
